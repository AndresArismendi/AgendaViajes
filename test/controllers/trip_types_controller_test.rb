...
class TripTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trip_type" do
    assert_difference('TripType.count') do
      post trip_types_url, params: { trip_type: { id_trip_type: @trip_type.id_trip_type, nombre: @trip_type.nombre } }
    end
  ...
  test "should update trip_type" do
    patch trip_type_url(@trip_type), params: { trip_type: { id_trip_type: @trip_type.id_trip_type, nombre: @trip_type.nombre } }
